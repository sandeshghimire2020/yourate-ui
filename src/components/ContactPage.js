        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-xl shadow-md p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-indigo-600 text-white font-medium py-3 px-6 rounded-lg hover:bg-indigo-700 transition"
              >
                Send Message
              </button>
            </form>
          ...
          <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@creatorrate.com</p>
                    <p className="text-gray-600">partnerships@creatorrate.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">We're active on these platforms:</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <div className="space-y-4">
                <a href="/about" className="flex items-center text-indigo-600 hover:text-indigo-800 transition">
                ...
                <a href="/how-it-works" className="flex items-center text-indigo-600 hover:text-indigo-800 transition">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="/top-creators" className="flex items-center text-indigo-600 hover:text-indigo-800 transition">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="/terms-of-service" className="flex items-center text-indigo-600 hover:text-indigo-800 transition">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="/privacy-policy" className="flex items-center text-indigo-600 hover:text-indigo-800 transition">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
